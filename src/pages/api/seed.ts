  ...
  await prisma.restaurant.createMany({
    data: [
      // INDIAN //
      {
        ...
        price: PRICE.REGULAR,
        description:
          "Vivaan is Modern Indian Cuisine serving dishes from different cuisines of India. We carefully select our ingredients and use them to make authentic Indian recipes and our chef puts his modern flair and twists to the dishes.",
        images: [
